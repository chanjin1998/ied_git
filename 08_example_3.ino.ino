...
#define _DIST_MID 200 // medium distance to be measured (unit: mm)

// global variables
float timeout; // unit: us
float dist_min, dist_max, dist_raw, dist_mid; // unit: mm
...
// turn on the LED if the distance is between dist_min and dist_max
  ...
  if( dist_raw>dist_min && dist_raw<200) {
    analogWrite(PIN_LED, 510-dist_raw/100*255);
  }
  if(dist_raw>200 && dist_raw<dist_max) {
    analogWrite(PIN_LED,dist_raw/100*255);
  }   
